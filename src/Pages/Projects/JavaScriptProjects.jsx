...
const JavaScriptProjects = () => {
    ...
    // Filter JavaScript projects (vanilla JS, not React/Next.js)
    ...
    return (
        <div className="bg-black text-white min-h-screen max-w-7xl md:mx-auto mt-4 md:px-20 px-4 py-8">
            <div className="mb-8">
                <Link to="/projects" className="text-yellow-400 hover:text-yellow-300 underline mb-4 inline-block">
                    ← Back to All Projects
                </Link>
                <h1 className="text-4xl font-bold text-center mb-2">JavaScript Projects</h1>
                <p className="text-gray-400 text-center">Vanilla JavaScript applications</p>
            </div>
            ...
            {javascriptProjects.length > 0 ? (
                ...
                <div className="text-center text-gray-400 py-20">
                    <p>No JavaScript projects found.</p>
                </div>
            )}
        </div>
    );
